...
**문서 버전 / 스냅샷:** 1.8 — §8.6 **reporting vs review boundary** 추가. §8.5 notification boundary·§4 전달/공유 policy와 함께 Living meaning model 블록이 우선이며, 버전 번호는 “이후 변경 불가”를 뜻하지 않는다.
