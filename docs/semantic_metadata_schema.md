...
| `document_flow_stage` | `array<string enum>` | 선택 | document submit/request/review/approve lifecycle: `request`, `submit`, `review`, `approve`, `reject_or_return`, `complete`. 제목 compound signal과 교집합 시 soft bonus (§8.3 `workflow_ontology.md`). |
