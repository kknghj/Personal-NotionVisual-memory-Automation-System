...
TITLE_SIGNAL_RULES: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ("interaction_mode", "create_edit", ("작성", "기안", "수정", "편집")),
    ...
    ("interaction_mode", "request_delegate", ("협조요청", "지급요청")),
    ("interaction_mode", "request_approval", ("승인요청", "결재요청", "결재받기")),
    ("interaction_mode", "review_request", ("검토요청", "확인요청")),
    (
        "interaction_mode",
        "submission_request",
        ("제출요청", "자료제출요청", "서류제출요청", "참가폼제출요청", "보완요청", "수정요청"),
    ),
    (
        "interaction_mode",
        "submit",
    ...
    ("interaction_mode", "approve_signoff", ("승인하기", "결재하기", "최종승인", "최종결재", "신청승인")),
    ...
    (
        "request_approval",
        "submission_request",
        ("제출요청", "자료제출요청", "서류제출요청", "참가폼제출요청"),
    ),
    ("request_approval", "revision_request", ("보완요청", "수정요청", "자료제출보완요청")),
    ("request_approval", "action_request", ("지급요청", "협조요청")),
)
...
def infer_title_semantic_signals(title: str) -> dict[str, set[str]]:
    ...
    if detect_status_work_action(title):
        interaction = signals.get("interaction_mode")
        if interaction:
            interaction.discard("create_edit")
            if not interaction:
                signals.pop("interaction_mode", None)
